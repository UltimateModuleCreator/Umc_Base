...
use Umc\Base\Validator\MethodValidator;
...
class MethodValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->mainModel->method('getParent')->willReturn(1);
        $validator = new MethodValidator('getParent', 'dummy error message');
    ...
    public function testValidateNotOk()
    {
        ...
        $this->mainModel->method('getSomething')->willReturn(null);
        $validator = new MethodValidator('getParent', $errorMessage);
