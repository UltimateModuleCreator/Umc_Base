...
use Umc\Base\Processor\ConstructorProcessor;
...
class ConstructorProcessorTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var ConstructorProcessor
     */
    protected $constructorProcessor;
    ...
    protected function setUp()
    {
        ...
        $this->constructorProcessor = new ConstructorProcessor($this->dependencyValidator, $this->modelProvider);
    ...
    protected function tearDown()
    {
        ...
        $this->constructorProcessor = null;
    }
    ...
    /**
     * @tests ConstructorProcessor::process()
     */
    public function testProcess()
    {
        ...
        $this->assertEquals($expected, $this->constructorProcessor->process($this->mainModel, $element, ''));
    }
    ...
    public function testProcessNotValid()
    {
        ...
        $this->assertEquals([], $this->constructorProcessor->process($this->mainModel, $element, ''));
    }
}
