...
use Umc\Base\Processor\PartProcessor;
use Umc\Base\Provider\Processor\ProviderInterface;

class PartProcessorTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->partProcessor       = new PartProcessor($this->dependencyValidator, $this->modelProvider);
    ...
    /**
     * @tests PartProcessor::process()
     */
    public function testProcess()
    {
        $this->dependencyValidator->method('validateDepend')->willReturn(true);
        $expected = 'content';
        $this->assertEquals($expected, $this->partProcessor->process($this->mainModel, [], 'content'));
    }
    ...
    public function testProcessNotValid()
    {
        ...
        $this->assertEquals('', $this->partProcessor->process($this->mainModel, [], 'content'));
    }
}
