 ...
 */
namespace Umc\Base\Model\Processor\Member\Entity;

use Umc\Base\Model\Processor\ProcessorInterface;
use Umc\Base\Model\Processor\Member\Entity as EntityMember;

class Relation extends EntityMember implements ProcessorInterface
{
    /**
